            ...
            <form className="flex flex-col" onSubmit={handleSubmit}>
                ...
                <div className='flex justify-center items-center rounded-xl mt-5'>
                    <div className='shrink-0 h-20 w-20 rounded-xl overflow-hidden '>
                        <img className='h-full w-full object-cover cursor-pointer' src={imgBase64 ||  nfthomepage} alt="nft"/>
                    </div>
                </div>
                <div className='flex justify-between items-center bg-gray-800 rounded-xl mt-5'>
                    <label className='block'>
                        ...
                        <input 
                         type="file" accept="image/png , image/jpg , image/jpeg ,image/webp "
                         className='block w-full text-sm text-slate-500 file:mr-4 file:py-2 file:px-4 file:rounded-full 
                         file:border-0 file:text-sm file:font-semibold hover:file:bg-[#1d2] 
                ...
                <div className='flex justify-between items-center bg-gray-800 rounded-xl mt-5'>
                        ...
                        <input 
                          type="text"  className='block w-full text-sm text-slate-300 
                ...
                <div className='flex justify-between items-center bg-gray-800 rounded-xl mt-5'>
                   ...
                   <textarea 
                     type="text"  className='block w-full text-sm text-slate-300 focus:outline-none cursor-pointer 
                ...
                <button
                type="submit"  
                className="flex justify-center items-center mt-5  p-2  
                shadow-lg shadow-black text-white text-sm 
                bg-[#e32970] hover:bg-[#bd255f] rounded-full px-1.5 py-2"
                onClick={handleSubmit}> Mint </button>
